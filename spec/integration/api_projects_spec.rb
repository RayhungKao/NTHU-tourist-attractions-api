...
describe 'Test Project Handling' do
  ...
  describe 'Getting projects' do
    it 'HAPPY: should be able to get list of all projects' do
      NTHUtouristAttractions::Project.create(DATA[:projects][0])
      NTHUtouristAttractions::Project.create(DATA[:projects][1])
    ...
    it 'HAPPY: should be able to get details of a single project' do
      ...
      NTHUtouristAttractions::Project.create(existing_proj)
      id = NTHUtouristAttractions::Project.first.id
    ...
    it 'SECURITY: should prevent basic SQL injection targeting IDs' do
      NTHUtouristAttractions::Project.create(name: 'New Project')
      NTHUtouristAttractions::Project.create(name: 'Newer Project')
  ...
  describe 'Creating New Projects' do
    ...
    it 'HAPPY: should be able to create new projects' do
      ...
      proj = NTHUtouristAttractions::Project.first
